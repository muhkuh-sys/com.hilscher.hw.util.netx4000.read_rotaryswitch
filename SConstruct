...
tElf90 = tEnv90.Elf('targets/netx90_com_intram/apply_hwconfig_netx90_com_intram.elf', tSrc90 + tEnv90['PLATFORM_LIBRARY'])
tTxt90 = tEnv90.ObjDump('targets/netx90_com_intram/apply_hwconfig_netx90_com_intram.txt', tElf90, OBJDUMP_FLAGS=['--disassemble', '--source', '--all-headers', '--wide'])
tBin90 = tEnv90.ObjCopy('targets/netx90_com_intram/apply_hwconfig_netx90_com_intram.bin', tElf90)
...
tElf4000 = tEnv4000.Elf('targets/netx4000/apply_hwconfig_netx4000.elf', tSrc4000 + tEnv4000['PLATFORM_LIBRARY'])
tTxt4000 = tEnv4000.ObjDump('targets/netx4000/apply_hwconfig_netx4000.txt', tElf4000, OBJDUMP_FLAGS=['--disassemble', '--source', '--all-headers', '--wide'])
tBin4000 = tEnv4000.ObjCopy('targets/netx4000/apply_hwconfig_netx4000.bin', tElf4000)
